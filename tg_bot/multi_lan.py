...
Step 1: extract texts
    ...
    - Disable comments with array location in code
...
TOKEN = '5503577784:AAEbi6cproQ0DDYhu4Lu3QtNaSE9h_57cg0'
...
# i18n = I18nM(path="locales", default_locale="en", domain="messages")
